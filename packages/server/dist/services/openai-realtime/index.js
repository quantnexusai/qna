...
const buildAndInitTool = async (chatflowid, _chatId, _apiMessageId) => {
    ...
    const reactFlowNodeData = await (0, utils_2.resolveVariables)(appServer.AppDataSource, nodeToExecute.data, reactFlowNodes, '', [], flowDataObj, '', availableVariables, variableOverrides);
