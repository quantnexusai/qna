...
exports.JsonOutputToolsParser = exports.ToolCallingAgentOutputParser = exports.XMLAgentOutputParser = exports.createReactAgent = exports.formatAgentSteps = exports.AgentExecutor = exports.AgentExecutorIterator = exports.ARTIFACTS_PREFIX = exports.SOURCE_DOCUMENTS_PREFIX = void 0;
...
class AgentExecutor extends chains_1.BaseChain {
    ...
    async _call(inputs, runManager, config) {
        ...
        const getOutput = async (finishStep) => {
            ...
            if (artifacts.length)
                additional.artifacts = (0, lodash_1.flatten)(artifacts);
            ...
            const newSteps = await Promise.all(actions.map(async (action) => {
                ...
                try {
                    ...
                    if (tool) {
                        ...
                        if (typeof toolOutput === 'string' && toolOutput.includes(exports.SOURCE_DOCUMENTS_PREFIX)) {
                            toolOutput = toolOutput.split(exports.SOURCE_DOCUMENTS_PREFIX)[0];
                        }
                        if (typeof toolOutput === 'string' && toolOutput.includes(exports.ARTIFACTS_PREFIX)) {
                            toolOutput = toolOutput.split(exports.ARTIFACTS_PREFIX)[0];
                        }
                        usedTools.push({
                            tool: tool.name,
                ...
                if (typeof observation === 'string' && observation.includes(exports.SOURCE_DOCUMENTS_PREFIX)) {
                ...
                if (typeof observation === 'string' && observation.includes(exports.ARTIFACTS_PREFIX)) {
                    const observationArray = observation.split(exports.ARTIFACTS_PREFIX);
                    observation = observationArray[0];
                    try {
...
class JsonOutputToolsParser extends output_parsers_1.BaseLLMOutputParser {
    ...
    constructor(fields) {
        super(fields);
        this.returnId = false;
        this.lc_namespace = ['langchain', 'output_parsers', 'openai_tools'];
