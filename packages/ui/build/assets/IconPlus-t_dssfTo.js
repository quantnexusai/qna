import{f as x,e as w,b_ as b,s as R,_ as o,E as _,b$ as u,r as $,k as S,l as M,j as U,m as j,n as A,a3 as P}from"./index-DnRqwzUl.js";function X(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function E(t){return parseFloat(t)}function I(t){return x("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const N=["animation","className","component","height","style","variant","width"];let r=t=>t,p,g,m,f;const B=t=>{const{classes:a,variant:e,animation:n,hasChildren:s,width:l,height:i}=t;return A({root:["root",e,n,s&&"withChildren",s&&!l&&"fitContent",s&&!i&&"heightAuto"]},I,a)},F=b(p||(p=r`
  0% {
    opacity: 1;
  }
