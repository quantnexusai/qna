...
declare class StripeTool extends StructuredTool {
    ...
    constructor(StripeAPI: StripeAPI, method: string, name: string, description: string, schema: z.ZodObject<any, any, any, any, {
        [x: string]: any;
    }>);
    _call(arg: z.output<typeof this.schema>, _runManager?: CallbackManagerForToolRun, _parentConfig?: RunnableConfig): Promise<any>;
}

type Object$1 = 'customers' | 'invoices' | 'invoiceItems' | 'paymentLinks' | 'products' | 'prices' | 'balance';
