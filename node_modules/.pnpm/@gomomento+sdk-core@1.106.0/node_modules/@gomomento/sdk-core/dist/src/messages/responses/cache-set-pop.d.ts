...
import { CacheSetPopResponse } from './enums';
interface IResponse {
    value(): string[] | undefined;
    readonly type: CacheSetPopResponse;
}
/**
...
export declare class Hit extends ResponseBase implements IResponse {
    ...
    readonly type: CacheSetPopResponse.Hit;
...
export declare class Miss extends BaseResponseMiss {
    readonly type: CacheSetPopResponse.Miss;
    value(): undefined;
}
/**
...
export declare class Error extends BaseResponseError implements IResponse {
    ...
    readonly type: CacheSetPopResponse.Error;
    value(): undefined;
}
