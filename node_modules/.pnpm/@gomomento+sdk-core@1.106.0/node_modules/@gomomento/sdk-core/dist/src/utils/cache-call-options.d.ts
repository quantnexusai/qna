...
export interface SetCallOptions extends ScalarCallOptions, CompressableCallOptions {
}
...
export interface SetIfAbsentCallOptions extends ScalarCallOptions, CompressableCallOptions {
}
 ...
 */
export declare function ttlOrFromCacheTtl(options?: CollectionCallOptions): CollectionTtl;
...
export declare enum LeaderboardOrder {
    Ascending = "ASC",
    Descending = "DESC"
}
