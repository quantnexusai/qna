...
class Data extends Collection_1.Collection {
    ...
    searchIterator(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let batchSize = Math.min(data.batchSize, total, __1.DEFAULT_MAX_SEARCH_SIZE);
            // Iterator fields
            ...
            const params = Object.assign(Object.assign({}, data.params), { [ITERATOR_FIELD]: true, [ITER_SEARCH_V2_KEY]: true, [ITER_SEARCH_BATCH_SIZE_KEY]: batchSize, [GUARANTEE_TIMESTAMP_KEY]: 0, [COLLECTION_ID]: collectionInfo.collectionID });
            return {
                    ...
                    return {
                        next() {
                            ...
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                try {
                                    const batchRes = yield client.search(Object.assign(Object.assign({}, data), { params, limit: batchSize }));
