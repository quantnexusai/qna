...
class VectorStoreIndex extends _BaseIndex.BaseIndex {
   ...
   */ static async fromDocuments(documents, args = {}) {
    ...
    static async fromVectorStores(vectorStores, serviceContext) {
        if (!vectorStores[_Node.ModalityType.TEXT]?.storesText) {
    ...
    static async fromVectorStore(vectorStore, serviceContext) {
        return this.fromVectorStores({
            [_Node.ModalityType.TEXT]: vectorStore
        }, serviceContext);
    }
    asRetriever(options) {
...
class VectorIndexRetriever {
    ...
    constructor({ index, similarityTopK, topK }){
        ...
        this.topK = topK ?? {
            [_Node.ModalityType.TEXT]: similarityTopK ?? _constants.DEFAULT_SIMILARITY_TOP_K,
            [_Node.ModalityType.IMAGE]: _constants.DEFAULT_SIMILARITY_TOP_K
        };
    }
    /**
   * @deprecated, pass topK in constructor instead
   */ set similarityTopK(similarityTopK) {
        this.topK[_Node.ModalityType.TEXT] = similarityTopK;
    }
    async retrieve({ query, preFilters }) {
        (0, _CallbackManager.getCallbackManager)().dispatchEvent("retrieve-start", {
            payload: {
                query
            }
        });
        ...
        (0, _CallbackManager.getCallbackManager)().dispatchEvent("retrieve-end", {
            payload: {
                query,
        ...
        (0, _CallbackManager.getCallbackManager)().dispatchEvent("retrieve", {
            query,
            nodes: nodesWithScores
        });
