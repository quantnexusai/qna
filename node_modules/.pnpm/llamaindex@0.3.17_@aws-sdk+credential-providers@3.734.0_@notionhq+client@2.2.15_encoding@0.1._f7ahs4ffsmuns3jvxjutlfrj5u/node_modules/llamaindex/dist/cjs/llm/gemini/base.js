...
const GEMINI_MODEL_INFO_MAP = {
    [_types.GEMINI_MODEL.GEMINI_PRO]: {
        contextWindow: 30720
    },
    [_types.GEMINI_MODEL.GEMINI_PRO_VISION]: {
        contextWindow: 12288
    },
    [_types.GEMINI_MODEL.GEMINI_PRO_LATEST]: {
        contextWindow: 10 ** 6
    },
    // multi-modal/multi turn
    [_types.GEMINI_MODEL.GEMINI_PRO_1_5_PRO_PREVIEW]: {
        contextWindow: 10 ** 6
    },
    [_types.GEMINI_MODEL.GEMINI_PRO_1_5_FLASH_PREVIEW]: {
        contextWindow: 10 ** 6
    },
    [_types.GEMINI_MODEL.GEMINI_PRO_1_5]: {
        contextWindow: 2 * 10 ** 6
    },
    [_types.GEMINI_MODEL.GEMINI_PRO_1_5_FLASH]: {
        contextWindow: 10 ** 6
    }
};
...
const DEFAULT_GEMINI_PARAMS = {
    model: _types.GEMINI_MODEL.GEMINI_PRO,
    temperature: 0.1,
    topP: 1,
    maxTokens: undefined
};
...
class GeminiSessionStore {
    static sessions = [];
    static getSessionId(options) {
        if (options.backend === _types.GEMINI_BACKENDS.GOOGLE) return options?.apiKey ?? "";
        return "";
    }
    static sessionMatched(o1, o2) {
        return GeminiSessionStore.getSessionId(o1) === GeminiSessionStore.getSessionId(o2);
    }
    static get(options = {
        ...
        if (options.backend === _types.GEMINI_BACKENDS.VERTEX) {
...
class Gemini extends _base.ToolCallLLM {
    ...
    constructor(init){
        super();
        _initProto(this);
        this.model = init?.model ?? _types.GEMINI_MODEL.GEMINI_PRO;
    ...
    async nonStreamChat(params) {
        const context = (0, _utils1.getChatContext)(params);
        ...
        return {
            ...
            message: {
                ...
                role: _utils1.GeminiHelper.ROLES_FROM_GEMINI[topCandidate.content.role]
            }
        };
    }
    ...
    async complete(params) {
        ...
        const client = this.session.getGenerativeModel(this.metadata);
        if (stream) {
            const result = await client.generateContentStream((0, _utils1.getPartsText)(_utils1.GeminiHelper.messageContentToGeminiParts(prompt)));
            return this.session.getCompletionStream(result);
        }
        const result = await client.generateContent((0, _utils1.getPartsText)(_utils1.GeminiHelper.messageContentToGeminiParts(prompt)));
        return {
