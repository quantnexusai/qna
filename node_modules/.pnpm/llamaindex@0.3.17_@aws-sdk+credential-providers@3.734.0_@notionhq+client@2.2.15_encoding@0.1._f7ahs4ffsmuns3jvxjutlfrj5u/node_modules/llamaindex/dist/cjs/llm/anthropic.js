...
_export(exports, {
    ALL_AVAILABLE_ANTHROPIC_LEGACY_MODELS: function() {
        return ALL_AVAILABLE_ANTHROPIC_LEGACY_MODELS;
    },
    ALL_AVAILABLE_ANTHROPIC_MODELS: function() {
        return ALL_AVAILABLE_ANTHROPIC_MODELS;
    },
    ALL_AVAILABLE_V3_MODELS: function() {
        return ALL_AVAILABLE_V3_MODELS;
    },
    Anthropic: function() {
        return Anthropic;
    },
...
class AnthropicSession {
    ...
    constructor(options = {}){
        ...
        this.anthropic = new _sdk.Anthropic(options);
    }
}
...
class Anthropic extends _base.ToolCallLLM {
    static{
    ...
    formatMessages(messages) {
        const result = messages.filter((message)=>message.role === "user" || message.role === "assistant").map((message)=>{
            ...
            if ("toolResult" in options) {
                    ...
                    content: [
                        {
                            ...
                            content: [
                                {
                                    type: "text",
                                    text: (0, _utils.extractText)(message.content)
                                }
                            ],
                            tool_use_id: id
                        }
                ...
                const aiThinkingText = (0, _utils.extractText)(message.content);
                return {
                    role: "assistant",
                    content: [
