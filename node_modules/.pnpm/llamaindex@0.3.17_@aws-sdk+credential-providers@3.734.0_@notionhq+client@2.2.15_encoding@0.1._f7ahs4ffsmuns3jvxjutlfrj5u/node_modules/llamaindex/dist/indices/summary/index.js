...
import { Settings, llmFromSettingsOrContext, nodeParserFromSettingsOrContext } from "../../Settings.js";
 ...
 */ export class SummaryIndex extends BaseIndex {
    ...
    static async fromDocuments(documents, args = {}) {
        ...
        const nodes = nodeParserFromSettingsOrContext(serviceContext).getNodesFromDocuments(documents);
