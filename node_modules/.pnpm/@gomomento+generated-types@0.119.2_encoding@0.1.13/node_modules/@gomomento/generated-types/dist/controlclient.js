...
(function (control_client) {
    ...
    class _CreateStoreRequest extends pb_1.Message {
        ...
        serialize(w) {
            ...
            if (this.store_name.length)
                writer.writeString(1, this.store_name);
            if (!w)
    ...
    class _ListStoresResponse extends pb_1.Message {
        constructor(data) {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, __ListStoresResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        serialize(w) {
            ...
            if (this.store.length)
                writer.writeRepeatedMessage(1, this.store, (item) => item.serialize(writer));
            if (this.next_token.length)
    ...
    class _SimilarityMetric extends pb_1.Message {
        constructor(data) {
            super();
            __SimilarityMetric_one_of_decls.set(this, [[1, 2, 3]]);
        ...
        serialize(w) {
            const writer = w || new pb_1.BinaryWriter();
            if (this.has_euclidean_similarity)
                writer.writeMessage(1, this.euclidean_similarity, () => this.euclidean_similarity.serialize(writer));
            if (this.has_inner_product)
                writer.writeMessage(2, this.inner_product, () => this.inner_product.serialize(writer));
            if (this.has_cosine_similarity)
                writer.writeMessage(3, this.cosine_similarity, () => this.cosine_similarity.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _CreateIndexRequest extends pb_1.Message {
        ...
        serialize(w) {
            ...
            if (this.num_dimensions != 0)
                writer.writeUint64(2, this.num_dimensions);
            if (this.has_similarity_metric)
                writer.writeMessage(3, this.similarity_metric, () => this.similarity_metric.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _ListIndexesResponse extends pb_1.Message {
        constructor(data) {
            ...
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, __ListIndexesResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        serialize(w) {
            ...
            if (this.indexes.length)
                writer.writeRepeatedMessage(1, this.indexes, (item) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _CacheLimits extends pb_1.Message {
        ...
        serialize(w) {
            const writer = w || new pb_1.BinaryWriter();
            if (this.max_traffic_rate != 0)
                writer.writeUint32(1, this.max_traffic_rate);
            if (this.max_throughput_kbps != 0)
                writer.writeUint32(2, this.max_throughput_kbps);
            if (this.max_item_size_kb != 0)
                writer.writeUint32(3, this.max_item_size_kb);
            if (this.max_ttl_seconds != 0)
                writer.writeUint64(4, this.max_ttl_seconds);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _TopicLimits extends pb_1.Message {
        ...
        serialize(w) {
            const writer = w || new pb_1.BinaryWriter();
            if (this.max_publish_rate != 0)
                writer.writeUint32(1, this.max_publish_rate);
            if (this.max_subscription_count != 0)
                writer.writeUint32(2, this.max_subscription_count);
            if (this.max_publish_message_size_kb != 0)
                writer.writeUint32(3, this.max_publish_message_size_kb);
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _Cache extends pb_1.Message {
        ...
        serialize(w) {
            ...
            if (this.cache_name.length)
                writer.writeString(1, this.cache_name);
            if (this.has_cache_limits)
                writer.writeMessage(2, this.cache_limits, () => this.cache_limits.serialize(writer));
            if (this.has_topic_limits)
                writer.writeMessage(3, this.topic_limits, () => this.topic_limits.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
