...
export declare namespace cache_client {
    ...
    export class _SetIfRequest extends pb_1.Message {
        #private;
        constructor(data?: any[] | ({
            cache_key?: Uint8Array;
            cache_body?: Uint8Array;
            ...
            present?: dependency_1.common.Present;
            present_and_not_equal?: never;
            absent?: never;
            equal?: never;
            absent_or_equal?: never;
            not_equal?: never;
        } | {
            present?: never;
            present_and_not_equal?: dependency_1.common.PresentAndNotEqual;
            absent?: never;
            equal?: never;
            absent_or_equal?: never;
            not_equal?: never;
            ...
            present?: never;
            present_and_not_equal?: never;
            absent?: dependency_1.common.Absent;
            equal?: never;
            absent_or_equal?: never;
            not_equal?: never;
        } | {
            ...
            present_and_not_equal?: never;
            absent?: never;
            equal?: dependency_1.common.Equal;
            absent_or_equal?: never;
            not_equal?: never;
        } | {
            present?: never;
            ...
            absent?: never;
            equal?: never;
            absent_or_equal?: dependency_1.common.AbsentOrEqual;
            not_equal?: never;
        } | {
            present?: never;
            present_and_not_equal?: never;
            ...
            equal?: never;
            absent_or_equal?: never;
            not_equal?: dependency_1.common.NotEqual;
        }))));
        get cache_key(): Uint8Array;
        set cache_key(value: Uint8Array);
        get cache_body(): Uint8Array;
        ...
        get ttl_milliseconds(): number;
        set ttl_milliseconds(value: number);
        get present(): dependency_1.common.Present;
        set present(value: dependency_1.common.Present);
        get has_present(): boolean;
        get present_and_not_equal(): dependency_1.common.PresentAndNotEqual;
        set present_and_not_equal(value: dependency_1.common.PresentAndNotEqual);
        get has_present_and_not_equal(): boolean;
        get absent(): dependency_1.common.Absent;
        set absent(value: dependency_1.common.Absent);
        get has_absent(): boolean;
        get equal(): dependency_1.common.Equal;
        set equal(value: dependency_1.common.Equal);
        get has_equal(): boolean;
        get absent_or_equal(): dependency_1.common.AbsentOrEqual;
        set absent_or_equal(value: dependency_1.common.AbsentOrEqual);
        get has_absent_or_equal(): boolean;
        get not_equal(): dependency_1.common.NotEqual;
        set not_equal(value: dependency_1.common.NotEqual);
        get has_not_equal(): boolean;
        get condition(): "none" | "present" | "present_and_not_equal" | "absent" | "equal" | "absent_or_equal" | "not_equal";
        static fromObject(data: {
            cache_key?: Uint8Array;
            cache_body?: Uint8Array;
            ttl_milliseconds?: number;
            present?: ReturnType<typeof dependency_1.common.Present.prototype.toObject>;
            present_and_not_equal?: ReturnType<typeof dependency_1.common.PresentAndNotEqual.prototype.toObject>;
            absent?: ReturnType<typeof dependency_1.common.Absent.prototype.toObject>;
            equal?: ReturnType<typeof dependency_1.common.Equal.prototype.toObject>;
            absent_or_equal?: ReturnType<typeof dependency_1.common.AbsentOrEqual.prototype.toObject>;
            not_equal?: ReturnType<typeof dependency_1.common.NotEqual.prototype.toObject>;
        }): _SetIfRequest;
        toObject(): {
            cache_key?: Uint8Array;
            cache_body?: Uint8Array;
        ...
        serialize(): Uint8Array;
        serialize(w: pb_1.BinaryWriter): void;
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): _SetIfRequest;
        serializeBinary(): Uint8Array;
        static deserializeBinary(bytes: Uint8Array): _SetIfRequest;
    }
    export class _SetIfResponse extends pb_1.Message {
        #private;
        constructor(data?: any[] | ({} & (({
        ...
        get stored(): _SetIfResponse._Stored;
        set stored(value: _SetIfResponse._Stored);
        get has_stored(): boolean;
        get not_stored(): _SetIfResponse._NotStored;
        set not_stored(value: _SetIfResponse._NotStored);
        get has_not_stored(): boolean;
        get result(): "none" | "stored" | "not_stored";
        static fromObject(data: {
            stored?: ReturnType<typeof _SetIfResponse._Stored.prototype.toObject>;
            not_stored?: ReturnType<typeof _SetIfResponse._NotStored.prototype.toObject>;
        }): _SetIfResponse;
        toObject(): {
            stored?: ReturnType<typeof _SetIfResponse._Stored.prototype.toObject>;
            not_stored?: ReturnType<typeof _SetIfResponse._NotStored.prototype.toObject>;
        ...
        serialize(): Uint8Array;
        serialize(w: pb_1.BinaryWriter): void;
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): _SetIfResponse;
        serializeBinary(): Uint8Array;
        static deserializeBinary(bytes: Uint8Array): _SetIfResponse;
    }
    export namespace _SetIfResponse {
    ...
    export class _ListFetchRequest extends pb_1.Message {
        ...
        constructor(data?: any[] | ({
            ...
            unbounded_start?: dependency_1.common._Unbounded;
            inclusive_start?: never;
        } | {
            unbounded_start?: never;
            inclusive_start?: number;
        }) | ({
            unbounded_end?: dependency_1.common._Unbounded;
            exclusive_end?: never;
        } | {
            unbounded_end?: never;
        ...
        get list_name(): Uint8Array;
        set list_name(value: Uint8Array);
        get unbounded_start(): dependency_1.common._Unbounded;
        set unbounded_start(value: dependency_1.common._Unbounded);
        get has_unbounded_start(): boolean;
        get inclusive_start(): number;
        set inclusive_start(value: number);
        get has_inclusive_start(): boolean;
        get unbounded_end(): dependency_1.common._Unbounded;
        set unbounded_end(value: dependency_1.common._Unbounded);
        ...
        static fromObject(data: {
            list_name?: Uint8Array;
            unbounded_start?: ReturnType<typeof dependency_1.common._Unbounded.prototype.toObject>;
            inclusive_start?: number;
            unbounded_end?: ReturnType<typeof dependency_1.common._Unbounded.prototype.toObject>;
            exclusive_end?: number;
        }): _ListFetchRequest;
        toObject(): {
            list_name?: Uint8Array;
