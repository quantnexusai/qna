...
(function (cache_client) {
    ...
    class _SetIfRequest extends pb_1.Message {
        constructor(data) {
            super();
            __SetIfRequest_one_of_decls.set(this, [[4, 5, 6, 7, 8, 9]]);
        ...
        serialize(w) {
            ...
            if (this.ttl_milliseconds != 0)
                writer.writeUint64(3, this.ttl_milliseconds);
            if (this.has_present)
                writer.writeMessage(4, this.present, () => this.present.serialize(writer));
            if (this.has_present_and_not_equal)
                writer.writeMessage(5, this.present_and_not_equal, () => this.present_and_not_equal.serialize(writer));
            if (this.has_absent)
                writer.writeMessage(6, this.absent, () => this.absent.serialize(writer));
            if (this.has_equal)
                writer.writeMessage(7, this.equal, () => this.equal.serialize(writer));
            if (this.has_absent_or_equal)
                writer.writeMessage(8, this.absent_or_equal, () => this.absent_or_equal.serialize(writer));
            if (this.has_not_equal)
                writer.writeMessage(9, this.not_equal, () => this.not_equal.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
        static deserialize(bytes) {
    ...
    class _SetIfResponse extends pb_1.Message {
        constructor(data) {
            super();
            __SetIfResponse_one_of_decls.set(this, [[1, 2]]);
