...
class CallbackHandler extends base.BaseCallbackHandler {
  ...
  async handleChainStart(chain, inputs, runId, parentRunId, tags, metadata, runType, name) {
    try {
      ...
      if (typeof inputs === "object" && "input" in inputs && Array.isArray(inputs["input"]) && inputs["input"].every(m => m instanceof messages.BaseMessage)) {
  ...
  extractUsageMetadata(generation) {
    try {
      const usageMetadata = "message" in generation && (generation["message"] instanceof messages.AIMessage || generation["message"] instanceof messages.AIMessageChunk) ? generation["message"].usage_metadata : undefined;
...
exports.createDatasetItemHandler = createDatasetItemHandler;
